...
# Analysis 3: Top 10 Countries by Investment in Latest Year
latest_year = education_data_cleaned['year'].max()
top_10_latest = education_data_cleaned[
    education_data_cleaned['year'] == latest_year
].nlargest(10, 'value')

plt.figure(figsize=(12, 6))
sns.barplot(data=top_10_latest, x='geo_time_period', y='value')
plt.title(f'Top 10 Countries by Education Investment ({latest_year})')
plt.xlabel('Country')
plt.ylabel('Investment Value')
...
# Analysis 4: Correlation with Economic Indicators
...
# Analysis 5: Policy Impact Analysis
if policy_docs:
...
# Analysis 6: Investment Efficiency Analysis
